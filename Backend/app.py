...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:5174", "https://route-optimizer-two.vercel.app", "https://route-optimizer-git-main-alex-eltons-projects.vercel.app"],
